...
<body>
    ...
    <button onclick="location.href = 'filter.php';" class='filter' name="submit" style=" color: black;background-color:  rgb(248, 248, 156);font-weight:800" onMouseOver="this.style.backgroundColor='#f6f600'" onMouseOut="this.style.backgroundColor='#f8f89c'">Filter</button>
    <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $query2 = "SELECT * FROM `$email` LIMIT $start,$limit";
